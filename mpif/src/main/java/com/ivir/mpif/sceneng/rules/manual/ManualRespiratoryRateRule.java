...
import static com.ivir.mpif.sceneng.rules.ReservedFacts.*;

public class ManualRespiratoryRateRule extends ManualRule<Float>{

    @Override
    public String getName() {
        return "manually update respiratory rate";
    }
    ...
    protected String getControlFactKey() {
        return "respiratory_rate_control";
    }

    @Override
    protected ReservedFacts getVitalsReservedFact() {
        return RESPIRATORY_RATE_FLT;
    }
