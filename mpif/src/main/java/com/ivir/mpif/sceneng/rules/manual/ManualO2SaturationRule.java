...
import static com.ivir.mpif.sceneng.rules.ReservedFacts.O2_SATURATION_FLT;

public class ManualO2SaturationRule extends ManualRule<Float>{

    @Override
    public String getName() {
        return "manually update O2 Saturation";
    }
    ...
    protected String getControlFactKey() {
        return "o2_saturation_control";
    }

    @Override
    protected ReservedFacts getVitalsReservedFact() {
        return O2_SATURATION_FLT;
    }
