...
public enum ImmuneTrigger {
    /** <code>notApplicable</code> (with ordinal 0) */
    NOT_APPLICABLE("notApplicable", 0),
    /** <code>viral</code> (with ordinal 1) */
    VIRAL("viral", 1),
    /** <code>bacterial</code> (with ordinal 2) */
    BACTERIAL("bacterial", 2),
    /** <code>parasitic</code> (with ordinal 3) */
    PARASITIC("parasitic", 3),
    /** <code>airwayAllergen</code> (with ordinal 4) */
    AIRWAY_ALLERGEN("airwayAllergen", 4),
    /** <code>inflammatory</code> (with ordinal 5) */
    INFLAMMATORY("inflammatory", 5);
    ...
    private ImmuneTrigger(String name, long ordinal) {
        this.name = name;
     ...
     */
    public static ImmuneTrigger find(long ordinal) {
        for (ImmuneTrigger value : values()) {
     ...
     */
    public static ImmuneTrigger find(String name) {
        for (ImmuneTrigger value : values()) {
