 ...
 * @author lewanw
 */
public class PhysicalTreatmentFile {
    ...
    public void setPhysicalTreatment(PhysicalTreatmentType physicalTreatment) {
    ...
    public void setDevice(TreatmentDevice device) {
        this.device = device;
    }
