...
java.exe -Ddevstudio.generatedcode.settings=FederateConfig.txt -cp %RTI_LIB%/portico.jar;libs/* -Djava.net.preferIPv4Stack=true com.ivir.mpif.MpifApplication
